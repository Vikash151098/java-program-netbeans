...
public class Book_Return extends JFrame implements ActionListener
    {
    ...
    private Object e;
    Choice c1,c2;
    public Book_Return(ResultSet rs ){ 
   ...
   /** String[] Branch={"Computer Science","Civil Engineering","Mechanical Engineering","Electrical Engineering","Electonics Engineering","Information Technology"};
       ...
       JLabel l4=new JLabel("Subject");
        ...
        add(l5);
        t3=new JTextField(rs.getString(4));//roll no. of student text 
        ...
        add(l1);
         t1=new JTextField(rs.getString(2));//issued date text field
        ...
        add(l2);
        t2=new JTextField(rs.getString(3)); //return date text field
...
{ 
      if(e.getSource()==b1){
          ...
          try
         {
            ...
            pr=con.prepareStatement("SELECT * FROM library ");
       ...
       catch(Exception e1)
       {
           ...
           JFrame j=new JFrame();
          j.setSize(100,200);
            JOptionPane.showMessageDialog(j,"Book is Returned");
      }
