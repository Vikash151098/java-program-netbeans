...
public class JApps extends JFrame {
	...
	public JApps() {
		...
		btnNewButton.setIcon(new ImageIcon(JApps.class.getResource("/com/appsworld/notepad.jpg")));
		...
		button.setIcon(new ImageIcon(JApps.class.getResource("/com/appsworld/calculator.jpg")));
		...
		button_1.setIcon(new ImageIcon(JApps.class.getResource("/com/appsworld/ip.jpg")));
		...
		button_2.setIcon(new ImageIcon(JApps.class.getResource("/com/appsworld/tictactoe.jpg")));
		...
		button_3.setIcon(new ImageIcon(JApps.class.getResource("/com/appsworld/picturepuzzle.jpg")));
		...
		button_4.setIcon(new ImageIcon(JApps.class.getResource("/com/appsworld/wct.jpg")));
		...
		button_5.setIcon(new ImageIcon(JApps.class.getResource("/com/appsworld/Puzzle Game.jpg")));
		...
		button_6.setIcon(new ImageIcon(JApps.class.getResource("/com/appsworld/Exam System.jpg")));
		...
		button_7.setIcon(new ImageIcon(JApps.class.getResource("/com/appsworld/Source Code Generator.jpg")));
