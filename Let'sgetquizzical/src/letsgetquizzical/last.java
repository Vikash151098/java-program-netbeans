...
public class last extends JFrame implements ActionListener {
   ...
   public last()
    ...
    setLayout(null);
    setResizable(false);
    img1=new ImageIcon(getClass().getResource("/image/congrats.jpg")); 
    l1=new JLabel(img1);
    setContentPane(l1);
    l1.setBounds(0,0,100,50);
     ...
     add(b1);
     img3=new ImageIcon(getClass().getResource("/image/home.jpg"));
        b2=new JButton(img3);
        b2.setBounds(10,380,60,50);
        b2.addActionListener(this);
        add(b2);
     l2=new JLabel("Congratulations!!!");
     l2.setBounds(100,50,550,40);
     Font ft1=new Font("forte", Font.ITALIC, 50);
     l2.setFont(ft1);
     l2.setForeground(Color.white); 
     add(l2);
     l3=new JLabel("GREAT JOB!!!.");
     l3.setBounds(150,200,550,40);
     Font ft2=new Font("forte", Font.BOLD, 38);
     l3.setFont(ft2);
     l3.setForeground(Color.white); 
     add(l3);
     l4=new JLabel("YOU ARE MILLIONARE & WON 10 LAKH!!!");
     l4.setBounds(20,290,550,40);
